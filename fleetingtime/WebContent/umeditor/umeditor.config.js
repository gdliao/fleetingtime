...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,toolbar:[
            ...
            'insertorderedlist insertunorderedlist | cleardoc paragraph fontsize' ,
            '| justifyleft justifycenter justifyright justifyjustify |',
            'link unlink ',
            '| horizontal source preview  '
        ]
		//removeformat | selectall | emotion image video  | map  print  fullscreen , 'drafts', 'formula'| fontfamily
