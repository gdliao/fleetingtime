...
<body>
	...
	<table style="margin: auto; margin-top: 15px;">
				<tr>
					<td>角色名称</td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;<input id="roleName" class="easyui-textbox theme-textbox-radius" data-options="prompt:''" style="width: 100;" /></td>
					<td><a href="#" class="easyui-linkbutton button-default button-sm" onclick="commit()">创建</a></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td></td>
